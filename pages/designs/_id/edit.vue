            ...
            <div class="card-body">
              <form class="auth-form" @submit.prevent="submit">
                ...
                <div class="text-right">
                  <nuxt-link :to="{ name: 'user-settings-designs' }"
                    >Cancel</nuxt-link
                  >
...
const InputTag = () => import("vue-input-tag");
...
export default {
  ...
  // asyncData bundan once calisti ve datayi cekti;
  mounted() {
    if (this.design) {
  ...
  methods: {
    submit() {
      this.form
        ...
        .then(res => {
          setTimeout(() => {
            this.$router.push({ name: "user-settings-designs" });
          }, 1000);
        })
